 ...
 * @LastEditTime: 2022-04-23 10:18:14
 * @LastEditors: 郑钊宇
 * @Description:
-->
<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="公开日" prop="openDay">
          <el-input v-model="temp.openDay" />
        </el-form-item>
      </el-form>
...
<script>
import { fetchPatentList, searchPatent, addPatent, deletePatent, updatePatent } from '@/api/characteristic/patent'
...
export default {
  ...
  methods: {
    ...
    handleFilter() {
      ...
      searchPatent(this.listQuery).then(response => {
        // console.log(response)
